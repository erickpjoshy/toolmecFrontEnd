...
const CategoryCard = ({ heading, category }) => {
        ...
        >
          ...
          {products.map((data, i) => {
            return (
              <div
                key={data._id}
                className="bg-white h-42 rounded-sm shadow  min-w-[345px]  max-w-[350px]  flex"
              >
                <Link
                  to={`productDetails/${data._id}`}
                  className="p-2 h-full min-w-[145px] flex items-center"
                >
                ...
                <div className="bg-fouth w-full p-4 grid">
                  ...
                  <div className="flex justify-center">
                    <button
                      className="text-small bg-red-600 hover:bg-red-700 text-white rounded-full px-3 py-0.5 w-[110px] z-10 relative"
